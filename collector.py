...
TEAM_KEYWORDS = {
    ...
    "MLB": {
        ...
        "Angels": ["angels", "los angeles angels", "anaheim"],
        ...
        "Athletics": ["athletics", "oakland", "sacramento", "a's"],
        ...
        "Cardinals": ["cardinals", "st. louis", "st louis cardinals"],
    },
    "NBA": {
        "Hawks": ["hawks", "atlanta"],
        ...
        "Bulls": ["bulls", "chicago"],
        "Cavaliers": ["cavaliers", "cleveland", "cavs"],
        "Mavericks": ["mavericks", "dallas", "mavs"],
        ...
        "Thunder": ["thunder", "oklahoma city"],
        "Magic": ["magic", "orlando"],
        "76ers": ["76ers", "philadelphia", "sixers"],
        "Suns": ["suns", "phoenix"],
        "Trail Blazers": ["trail blazers", "portland", "blazers"],
